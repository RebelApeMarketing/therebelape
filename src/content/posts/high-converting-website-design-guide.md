...
<script type="application/ld+json">
{
  ...
  "description": "A proven 5-step process for designing contractor websites that generate leads and revenue.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Message Development",
      "text": "Define your unique positioning, pain points you solve, trust signals, and offer. This becomes the blueprint for everything else.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Text-Based Outline",
      "text": "Create a script-like outline of the entire page, mapping the customer journey from problem awareness to taking action.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Wireframing",
      "text": "Add structure showing where every element goes, how big elements should be, and how to guide the eye down the page.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Visual Design",
      "text": "Apply your branding to the wireframe using professional photography, appropriate white space, and mobile-first design principles.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Development & Conversion Optimization",
      "text": "Convert the design to code, optimize for speed (under 2 seconds load time), set up click-to-call, forms, and analytics tracking.",
      "position": 5
    }
  ],
  "totalTime": "PT4W"
