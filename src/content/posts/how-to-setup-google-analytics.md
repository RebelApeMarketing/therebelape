---
title: "How to Setup Google Analytics So You Know Where Leads Actually Come From"
slug: "how-to-setup-google-analytics"
description: "Stop tracking vanity metrics. Learn how to setup Google Analytics to track real local traffic, conversion sources, and the metrics that actually matter for contractor businesses."
excerpt: "Most contractors track pageviews and celebrate traffic numbers that mean nothing. Real Google Analytics setup means knowing where your leads come from, which pages convert, and whether you're getting local traffic or bot impressions from overseas spam farms."
author: "Adam Miconi"
publishDate: "2018-04-28T10:00:00-06:00"
lastModified: "2026-02-02T10:00:00-07:00"
image: "https://RebelApeCDN.b-cdn.net/featured-google-analytics-setup.webp"
canonicalUrl: "https://therebelape.com/blog/how-to-setup-google-analytics/"
tags: ["contractor marketing", "google analytics", "marketing analytics", "lead tracking", "conversion tracking"]
...
**Don't know how to check if your tracking is installed properly? [Let us audit your setup](/contact/) and tell you exactly what's broken.**
...
If you're running Google Ads campaigns, you need different data than if you're focused purely on [organic search visibility](/blog/how-to-improve-website-traffic-with-seo-your-complete-2025-guide/). If your busy season is May through September, you need to understand seasonal trends. If you serve a specific geographic area, you need to filter out traffic from people who will never call you.
...
Set up location reports in GA4 to see where your visitors are actually coming from. If you're getting significant traffic from outside your service area, something's wrong with your [local SEO setup](/blog/local-seo-services-increase-local-visibility-and-drive-more-customers/) or your targeting.
...
If you've invested in [SEO for specific service pages](/blog/seo-tips-for-plumbers/), you need to know if those pages are getting traffic. If you're running ads to a landing page, you need to know if people are finding it through organic search too.
...
Look for patterns. Are people landing on your blog posts and then navigating to service pages? Or are they landing on service pages directly? This tells you how your [content marketing](/blog/professional-content-writing-business-authority-benefits/) is performing.
...
**This is exactly what we optimize when we build [complete contractor marketing systems](/services/). Want to see how we track and improve all of this? Here's our approach.**

### 5. Page Performance for Key Pages

You've got pages that matter more than others:
- Your main service pages
- Your [Google Ads landing pages](/blog/plumbing-website-conversion-fixes/)
- Your contact page
...
If you're running ads to a landing page that's getting 500 visits but zero conversions, you don't have a traffic problem. You have a [conversion problem](/blog/what-makes-a-high-converting-webpage/).
...
If you're running [Google Ads campaigns](/services/ppc/), connect GA4 to your Google Ads account. This lets you see not just how many clicks you're getting, but what those clicks do on your website.
...
- Optimized their [Google Business Profile](/blog/total-market-domination-with-google-business-profile/) for local search
- Built out their service pages with real content
- Improved their [website conversion elements](/blog/high-converting-website-design-guide/)
...
2. Install the tracking code on your website (use a plugin like Site Kit by Google if you're on WordPress)
3. Verify the code is firing on all pages
4. Set up your geographic filters
5. Connect to Google Ads if you're running campaigns
6. Configure your key page tracking
7. Set up custom reports for the 7 metrics above
...
**Most contractors realize this is too technical or they don't have time. That's fine - [we can set this up and monitor it for you](/contact/). You get the data, we handle the complexity.**
...
**Questions about whether your analytics setup is actually tracking real data? [Schedule a call](/schedule/) and we'll audit what you've got.**